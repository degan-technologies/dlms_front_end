            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <small v-if="submitted && !name" class="p-error block mb-4"
                        ...
                        <small v-if="submitted && !email" class="p-error block mb-4"
                        ...
                        <div class="mb-8 mt-4">
                            <Checkbox
                                ...
                                id="acceptTerms"
                                binary
                                :class="{ 'p-invalid': submitted && !acceptTerms }"
                                class="mr-2"></Checkbox>
                            <label
                                for="acceptTerms"
                                :class="{ 'p-error': submitted && !acceptTerms }">
                                I agree to the
                                <a href="#" class="text-primary">terms and conditions</a>
                            </label>
                            <small v-if="submitted && !acceptTerms" class="p-error block mt-2"
