    ...
    <section class="bg-white min-h-screen py-12 px-5">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-10">
                <div>
                    <div class="text-blue-600 font-semibold mb-1 tracking-widest uppercase">Reading List</div>
            ...
            <div v-else-if="!collection || !collection.ebooks || collection.ebooks.length === 0" class="bg-white p-12 rounded-lg text-center shadow-sm">
                ...
                <p class="text-gray-500 max-w-md mx-auto">This public collection currently has no resources.</p>
            </div>
            <div v-else>
...
const fetchCollection = async () => {
    loading.value = true;
    try {
        const response = await axiosInstance.get(`/collections/${route.params.id}`, {
            params: {
