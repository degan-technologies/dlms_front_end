...
const activeFiltersList = computed(() => {
    ...
    if (selectedBranch.value) {
        const branch = branchOptions.value.find(
            (b) => b.value === selectedBranch.value,
        );
        if (branch) {
            activeFilters.push({
                type: "branch",
...
const removeFilter = (filter) => {
    switch (filter.type) {
        ...
        case "status":
            ...
            break;
        case "cover":
            selectedCoverTypes.value = selectedCoverTypes.value.filter(
                (c) => c !== filter.value,
            );
            break;
        case "reference":
...
function applyFilters() {
    ...
    let params = {
        ...
        availability_status: selectedStatuses.value.length
...
function onSort(event) {
    ...
    sortField.value = valid.includes(event.sortField)
        ? event.sortField
        : "created_at";
...
<template>
    <div class="card">
        ...
        <p class="mt-2 mb-4 text-gray-600">
            Browse, search, and manage the physical books available in the
            library.
        </p>
        ...
        <div class="filter-container mb-4">
            ...
            <div
                v-if="displayFilters"
                class="filter-panel p-3 mb-4 surface-ground border-round"
            >
                <div class="grid">
                            ...
                            >
                                ...
                                >
                                    <Tag
                                        :value="status.label"
                                        :severity="
                                            getStatusSeverity(status.value)
                                        "
                                        class="mr-2"
                                    />
                                </label>
                    ...
                    <div class="col-12 md:col-4 lg:col-3 xl:col-2 filter-group">
                        ...
                        <div class="filter-options">
                            ...
                            <div class="filter-option mt-2">
                                ...
                                />
                                <label for="reference-only" class="ml-2"
                    ...
                    <div v-if="showMoreFilters" class="col-12">
                        <div class="grid">
                            <!-- Branch Location -->
                            <div
                                class="col-12 md:col-4 lg:col-3 xl:col-2 filter-group"
                            >
                                <div class="filter-header">
        ...
        >
            <template #empty>
                <div class="p-4 text-center">
                    <i
                        class="pi pi-folder-open text-primary"
            ...
            <Column header="Id" headerStyle="min-width:5rem; max-width:8rem">
            ...
            <!-- Author -->
            <Column header="Edition" sortable>
                <template #body="{ data }"> {{ data.edition }} </template>
            </Column>
            <!-- Publisher -->
            <Column header="ISBN" sortable>
                <template #body="{ data }"> {{ data.isbn }} </template>
            </Column>
            <!-- Year -->
            ...
            <!-- Status -->
            <Column header="IsReserved" sortable headerStyle="width:8rem">
                <template #body="{ data }"> {{ data.is_reserved }} </template>
            </Column>
            <!-- Location -->
            <Column header="Location" sortable headerStyle="min-width:10rem">
                <template #body="{ data }">
                    <div>
                        <div>Branch ID: {{ data.library_id }}</div>
            ...
            <Column header="IsBorrowable" sortable headerStyle="width:8rem">
                <template #body="{ data }">
                    {{ data.reference_only }}
                </template>
            </Column>
            ...
            <Column
                headerStyle="min-width:10rem; text-align:center"
