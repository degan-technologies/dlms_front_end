<template>
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <div
      v-for="question in visitorMessages"
      :key="question.id"
      class="bg-white shadow rounded-lg mb-6 p-4 border border-gray-200"
    >
      <!-- Visitor Question -->
      ...
      <div
        v-if="replyMap[question.id]"
        class="flex items-start gap-3 ml-12 mt-2"
      >
...
const visitorMessages = computed(() =>
  messages.value.filter((msg) => msg.sender === 'visitor')
);
