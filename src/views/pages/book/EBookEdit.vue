...
<template>
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <h5>Edit E-Book</h5>
                <p class="text-gray-600 mb-4">Update the details for this e-book in the digital library.</p>
                ...
                <form v-else @submit.prevent="submitForm" class="p-fluid">
                    <div class="grid formgrid">
                        ...
                        <div class="col-12 mt-4 flex justify-content-end">
                            ...
                            <Button label="Update E-Book" icon="pi pi-check" class="p-button-primary" type="submit" :loading="loading" />
                        </div>
                    </div>
                </form>
            </div>
