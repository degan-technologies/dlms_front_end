        ...
        <section class="bg-gradient-to-b from-blue-50 to-white min-h-screen py-12 px-5">
            <div class="max-w-5xl mx-auto">
                ...
                <div v-else>
                    ...
                    <div class="relative">
                        <button v-if="ebooksFirst > 0" @click="prevPage" class="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-full p-2 shadow transition-all">
