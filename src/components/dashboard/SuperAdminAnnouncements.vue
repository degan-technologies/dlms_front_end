...
const fetchAnnouncements = async () => {
    try {
        loading.value = true;
        const response = await axiosInstance.get('/superadmin/announcements');
...
const saveAnnouncement = async () => {
    try {
        if (editingId.value) {
            await axiosInstance.put(`/superadmin/announcements/${editingId.value}`, form.value);
            toast.add({
                severity: 'success',
                summary: 'Success',
            ...
            await axiosInstance.post('/superadmin/announcements', form.value);
            toast.add({
                severity: 'success',
                summary: 'Success',
...
const deleteAnnouncement = (id) => {
    confirm.require({
        ...
        accept: async () => {
            try {
                await axiosInstance.delete(`/superadmin/announcements/${id}`);
                toast.add({
                    severity: 'success',
                    summary: 'Success',
